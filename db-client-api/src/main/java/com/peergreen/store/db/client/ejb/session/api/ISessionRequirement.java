...
public interface ISessionRequirement {
     ...
     */
    Requirement addRequirement(String requirementName,
            String namespace, String filter) throws EntityAlreadyExistsException;
     ...
     * @throws NoEntityFoundException if the requirement doesn't exist
     */
    Collection<Petal> collectPetals(String requirementName)
            throws NoEntityFoundException;

    /**
     * Method to add a petal to the list of petals which have
     * this specific requirement.
     *
     * @param requirement requirement that is needed by the petal
     * @param petal petal to add 
     * @return modified requirement (updated list of petals which 
    ...
    /**
     * Method to remove a petal from the list of petals which share
     * this specific requirement.
     *
    ...
    /**
     * Method to find matching between LDAP expression (Requirement filter)
     * and Capabilities.
     *
     * @param namespace request namespace
     * @param requirement requirement containing all constraints to resolve
